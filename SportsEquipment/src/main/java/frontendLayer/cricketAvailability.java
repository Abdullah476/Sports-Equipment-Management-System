...
public class cricketAvailability implements Initializable {
	@FXML
	...
	public void initialize(URL url, ResourceBundle resourceBundle) {
		if (Objects.equals(Controller.checkCricketAvailablity(), "true")) {
			message.setText("Cricket Ground Made Unavailable");
		}
		else {
			message.setText("Cricket Ground Made Available");
		}
		Controller.changeCricketAvailability();
	}
}
